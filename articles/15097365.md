...
<p class="no-margin"></p>
<p class="no-margin">La forma habitual es desde el listado de <b>Presupuestos</b> (abre
<b>Presupuestos</b> en el menú principal). Pulsa el botón de crear
nuevo. También puedes llegar desde:</p>
<p class="no-margin"></p>
<ul>
<li><p class="no-margin">El botón <b>+</b> (<code>Crear documento</code>) de <b>Inicio</b> → <b>Presupuesto</b>.</p></li>
...
factura — ver el patrón en <a href="https://help.facturadirecta.com/es/articles/15097366"><b>Crear una factura de venta</b></a> — con las
diferencias:</p>
<p class="no-margin"></p>
<ul>
...
<p class="no-margin"></p>
<ul>
<li><p class="no-margin"><a href="https://help.facturadirecta.com/es/articles/15097366"><b>Crear una factura de venta</b></a> — el paso natural cuando el
presupuesto se acepta.</p></li>
<li><p class="no-margin"><a href="https://help.facturadirecta.com/es/articles/15097364"><b>Crear un albarán</b></a> — alternativa antes de facturar.</p></li>
